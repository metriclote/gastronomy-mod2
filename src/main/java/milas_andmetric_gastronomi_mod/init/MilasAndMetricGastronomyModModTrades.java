...
public class MilasAndMetricGastronomyModModTrades {
	...
	public static void registerTrades(VillagerTradesEvent event) {
		...
		if (event.getType() == MilasAndMetricGastronomyModModVillagerProfessions.VENDEDORCHINO.get()) {
		...
		if (event.getType() == MilasAndMetricGastronomyModModVillagerProfessions.VENDEDORCHINO.get()) {
			event.getTrades().get(5).add(new BasicItemListing(new ItemStack(Items.EMERALD), new ItemStack(MilasAndMetricGastronomyModModItems.DELETED_MOD_ELEMENT.get()), 20, 10, 0.05f));
		}
		if (event.getType() == VillagerProfession.FARMER) {
